...
///
/// You need local [Flare](https://github.com/2d-inc/Flare-Flutter) `.flr` asset for this type of Giff Dialog.
...
/// ```
/// Set [FlareGiffDialog]'s [flarePath] prop to the asset path.
...
///   ...,
/// );
class FlareGiffDialog extends StatelessWidget {
